...
export default function DhamGoals() {
    return (
        <section className={"flex flex-col relative bg-background"}>
            ...
            <div
                className={"bg-[url('/assets/goals_bg.png')] bg-cover bg-no-repeat bg-center px-[150px] pt-[48px] pb-[52px] max-xl:px-[5%] max-md:p-[20px] "}>
                <div className={"flex flex-col items-center justify-center gap-[30px] max-md:gap-[20px]"}>
                    ...
                    <div className={"flex items-center justify-center flex-wrap gap-[35px] max-md:gap-[20px] max-md:justify-start"}>
                        {goalList.map(item => (
                            <div key={item.key} className="basis-[48%] max-w-[60%] shrink grow max-lg:basis-[100%] max-lg:max-w-[100%] max-md:basis-[100%] max-md:max-w-full max-md:shrink-0 max-md:grow-0">
                                <GoalCard
                                    label={item.label}
                                    icon={item.icon} />
                            </div>
            ...
            <div className={"px-[150px] pb-[72px] max-xl:px-[5%] max-md:px-[20px] max-md:pb-[27px]"}>
